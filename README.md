---
ProjectName: CozumSigorta
Development Process Time: "2024-27-03 / 2024-28-03"
spoiler: Dynamic With React
FE, BE: ["React"]
...
### 🔗 <code><a href="https://cozumsigorta.vercel.app/" target="_blank"> Vercel Deployment </a></code>

## Getting Started 🖱️

To get started you can simply clone this `cozumsigorta` repository and install the dependencies.

Clone the `cozumsigorta` repository using git:

```bash
git clone https://github.com/gokhangultan/cozumsigorta.git
```
